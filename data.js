...
var QUIZ_STEPS = [
  ...
  // STEP 2: The fighting
  {
    ...
    multi: true,
    options: [
      { id: "c_same",     label: "We have the same fight on repeat. Nothing ever resolves.",  emoji: "🔁", weight: "leave" },
      ...
      { id: "c_avoids",   label: "We avoid conflict entirely so nothing ever gets addressed.",emoji: "🙈", weight: "complicated" },
  ...
  // STEP 3: Day to day
  {
    ...
    options: [
      ...
      { id: "d_alone",   label: "I feel more alone with them than I would be without.", emoji: "🏝️", weight: "leave" },
  ...
  // STEP 4: Trust
  {
    ...
    options: [
      ...
      { id: "t_lies",     label: "I've caught them in lies. Small ones, or big ones.",   emoji: "🤥", weight: "leave" },
      { id: "t_gut",      label: "Something feels off. I just can't prove it.",          emoji: "🌡️", weight: "complicated" },
